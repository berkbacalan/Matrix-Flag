...
from ..models.ab_testing import (
    Experiment, Variant, ExperimentStatus,
    ExperimentAssignment, MetricValue, ExperimentResult
)
...
class ABTestingService:
    ...
    async def assign_variant(self, experiment_name: str, user_id: str, context: Dict[str, Any]) -> Optional[str]:
    ...
    async def record_metric(self, experiment_name: str, variant_name: str, metric_name: str, value: float) -> None:
    ...
    async def get_experiment_results(self, experiment_name: str) -> List[ExperimentResult]:
        ...
        for variant in experiment.variants:
            ...
            variant_users = [
                user_id for user_id, assignment in assignments.items()
